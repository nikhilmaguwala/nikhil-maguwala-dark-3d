import {
  ...
  jobit,
  tripguide,
  threejs, abaut, geeks, gps, lanet, angular, flask, python, chatgpt, spplstm, geeksacademy, icr,
} from "../assets";
  ...
  const projects = [
    ...
    },
    {
      ...
      image: icr,
      source_code_link: "https://github.com/nikhilmaguwala/image_classification_resnet50",
    },
  ];
